...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_leftimageview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='leftimageview'
        )
        self.assertTrue(view.__name__ == 'leftimageview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in leftimageview'
        # )

    def test_leftimageview_not_matching_interface(self):
