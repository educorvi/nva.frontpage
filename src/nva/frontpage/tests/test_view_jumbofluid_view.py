...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_jumbofluid_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='jumbofluid-view'
        )
        self.assertTrue(view.__name__ == 'jumbofluid-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in jumbofluid-view'
        # )

    def test_jumbofluid_view_not_matching_interface(self):
