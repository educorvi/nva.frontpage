...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_rightimageview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='rightimageview'
        )
        self.assertTrue(view.__name__ == 'rightimageview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in rightimageview'
        # )

    def test_rightimageview_not_matching_interface(self):
