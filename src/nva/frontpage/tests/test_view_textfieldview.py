...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_textfieldview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='textfieldview'
        )
        self.assertTrue(view.__name__ == 'textfieldview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in textfieldview'
        # )

    def test_textfieldview_not_matching_interface(self):
